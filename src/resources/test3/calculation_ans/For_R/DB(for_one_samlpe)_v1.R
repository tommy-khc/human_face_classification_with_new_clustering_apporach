...
directory<-"/Users/Tomy_Chan/Documents/OneDrive - HKUST Connect/Yr4/Spring/MATH4983F/MATH4983F/Code/Code_for_ORL/Clustering_ORL/v2/test3(take_this)/calculation_ans/For_R"
New_no_match_file<-file.path(directory,"New_no_match_v2_test3_4.txt")
...
clust_file<-file.path(directory,"clust_v2_test3_4.txt")
